...
# m = p.match('casse') #match: 주어진 문자열의 처음부터 일치하는지 확인
# print_match(m)

# s = p.search('good case') #search: 주어진 문자열중에 일치하는게 있는지 확인
# print_match(s)
...
# 원하는 형태로 내보내기 : 정규식
# . (ca.e) : 하나의 문자 > cale, case | not caffe
# ^ (^de) : 문자열의 시작 > desk, define | not fade
# $ (se$) : 문자열의 끝 > case, base | not face